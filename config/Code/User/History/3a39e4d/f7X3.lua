...
frames.notification:SetSize(Frame1:GetWidth(), 30)
frames.notification:Hide()
frames.notification:SetPoint("TOP", ChatFrame1, 0, 0)
...
frames.spellqueueholder:SetPoint("CENTER", ChatFrame1, "BOTTOM", 0, 130)
...
frames.floatingtext:SetPoint("CENTER", ChatFrame1, 0, 80)
